...
echo -e " $COLOR1╰═════════════════════════════════════════════════╯${NC}"  
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1${NC}                 • XlordVpn •                 $COLOR1$NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════╯${NC}"  
echo -e ""
...
git clone https://github.com/${USERGIT}/psby.git &> /dev/null
cd /root/psby/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch ip &> /dev/null
...
echo "${TEXT}" >>/root/psby/newuser 
echo "### $client $exp $daftar $isadmin" >>/root/psby/calo 
git add .
git commit -m register &> /dev/null
git branch -M ipuk &> /dev/null
git remote add origin https://github.com/${USERGIT}/psby.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/psby.git &> /dev/null
sleep 1
clear
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1$NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1${NC}  SUKSES MENAMBAH IP BARU"
echo -e "$COLOR1${NC}"
...
" 
echo "${TEXTD}" >>/root/psby/delete_log  &> /dev/null
...
git commit -m renew
git branch -M ipuk
git remote add origin https://github.com/${USERGIT}/psby.git
git push -f https://${APIGIT}@github.com/${USERGIT}/psby.git
clear
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1$NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════╯${NC}" 
...
echo -e "$COLOR1${NC} [INFO] Buy Premium Membership : t.me/xlordeuyy"
echo -e "$COLOR1${NC} [INFO] SCRIPT BY : XLORD VPN ®"
echo -e " $COLOR1╰═════════════════════════════════════════════════╯${NC}"  
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1${NC}                 • XlordVpn •                 $COLOR1$NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════╯${NC}"  
