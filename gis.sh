...
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 ${NC}                 • $xlord •                 $COLOR1 $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e ""
...
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
rm -rf /root/psby/calo
read -p "   NEW IPVPS : " daftar
echo -e "$COLOR1 ${NC}"
echo -e "$COLOR1 ${NC}  [INFO] Checking the IPVPS!"
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/psby/main/calo | awk '{print $4}' | grep $daftar)
if [[ $daftar = $REQIP ]]; then
echo -e "$COLOR1 ${NC}  [INFO] IP MU UDAH TERDAFTAR"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 ${NC}                 • $xlord •                 $COLOR1 $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
...
echo -e "$COLOR1 ${NC}  [INFO] OK! IP VPS BLUM TERDAFTAR"
echo -e "$COLOR1 ${NC}  [INFO] Lanjut Daftar"
sleep 3
clear
fi
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
...
git clone https://github.com/${USERGIT}/calo.git &> /dev/null
cd /root/psby/calo/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch ip &> /dev/null
...
Reg Date    : $hariini
" 
echo "${TEXT}" >>/root/psby/calo/newuser 
echo "### $client $exp $daftar $isadmin" >> /root/psby/calo 
git add .
git commit -m register &> /dev/null
git branch -M ipuk &> /dev/null
git remote add origin https://github.com/${USERGIT}/calo.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/calo.git &> /dev/null
sleep 1
clear
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
TEXT="
<code>◇━━━━━━━━━━━━━━━━━◇</code>
     <b>☘️SUCCES REGIS IP☘️</>
<code>◇━━━━━━━━━━━━━━━━━◇</code>
<code>IP : $daftar</code>
<code>ADMIN ON/OFF : $isadmin</code>
<code>USER : $client</code>
<code>TGL REGIS : $TheKill</code>
<code>EXP : $exp</code>
<code>◇━━━━━━━━━━━━━━━━━◇</code>
<code>Link Install : </code>
<code>[wget --no-check-certificate https://xlordofc.com/xpy.sh && chmod +x xpy.sh && ./xpy.sh]</code>
<code>◇━━━━━━━━━━━━━━━━━◇</code>
<code>☘️ TNKS FOR USING MY SCRIPT☘️</code>
<code>◇━━━━━━━━━━━━━━━━━◇</code>
...
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 2-4 | nl -s '. '
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 ${NC}                 • $xlord •                 $COLOR1 $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
...
name1=$(grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 2 | sed -n "$nombor"p) #name
exp=$(grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 3 | sed -n "$nombor"p) #exp
ivps1=$(grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 4 | sed -n "$nombor"p) #ip
sed -i "s/### $name1 $exp $ivps1//g"  /root/psby/calo &> /dev/null
...
" 
echo "${TEXTD}" >>/root/psby/calo/delete_log  &> /dev/null
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/calo.git
cd /root/psby/calo/
rm -rf .git
git init
touch ip
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " " /root/psby/calo")
...
name1=$(grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p) #name
exp=$(grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p) #exp
ivps1=$(grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p) #ip
...
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp4 $ivps1/g"  /root/psby/calo
git add .
git commit -m renew
git branch -M ipuk
git remote add origin https://github.com/${USERGIT}/calo.git
git push -f https://${APIGIT}@github.com/${USERGIT}/calo.git
clear
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1 $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
...
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
grep -E "^### " " /root/psby/calo" | cut -d ' ' -f 2 | nl -s '. '
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 ${NC}                 • $xlord •                 $COLOR1 $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}" 
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/salamsatuu/psby/main/calo | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e " $COLOR1╭═════════════════════════════════════════════════╮${NC}"
